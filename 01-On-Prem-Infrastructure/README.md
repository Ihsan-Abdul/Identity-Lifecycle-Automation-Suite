...
### Overview
This portion of the project demonstrates the development of an Identity Lifecycle Management (JML) automation framework using PowerShell and Active Directory.
